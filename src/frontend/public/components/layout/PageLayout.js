        ...
        <section class="page__layout">
            <header class="navbar" id="navbar">
                ...
                <nav class="navbar__links" id="navbar_links">
                    ...
                    ${userType === "cliente" ? `<a id="toggleProductCart" class="link" href="/user/product-cart"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cart-fill" viewBox="0 0 16 16">
